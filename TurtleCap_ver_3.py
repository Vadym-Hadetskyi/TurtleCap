...
class App:
    ...
    def GUI(self):
        ...
        # flash forward button
        im_play = PIL.Image.open("flashforward.png")
        im_play = im_play.resize((50, 50), PIL.Image.ANTIALIAS)
...
class VideoCap:
    ...
    def flashforward(self):
        # method that performs a flashforward in the video for a size of Q
        self.stop()
        for i in range(self.Q.qsize()):
            self.read()
        self.timestamps = np.empty(self.Q.qsize())
        self.start()
